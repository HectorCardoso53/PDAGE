    ...
    <div className="min-h-screen bg-primary-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-lg">Classificação e Pontuações</p>
        </div>
        ...
        <div className="bg-primary-800 border border-white/10 rounded-2xl p-8 mb-6">
          ...
          <p className="text-gray-300 text-base leading-relaxed">
            A página de resultados exibirá a classificação final dos candidatos com pontuação
            consolidada de todas as etapas do processo avaliativo. Disponível após a conclusão do
            processo seletivo.
          </p>
        </div>
